...
/**
 * POST api/profile/experience route
...
router.post('/experience', passport.authenticate('jwt', { session: false }), (req, res) => {
  ...
  Profile.findOne({ user: req.user.id })
    .then((profile) => {
      ...
      return profile.save().then(newProfile => res.json(newProfile));
    });
  return null;
});

/**
 * POST api/profile/education route
...
/**
 * DELETE api/profile/experience/:exp_id route
...
/**
 * DELETE api/profile/education/:edu_id route
